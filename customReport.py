...
class ManagementReportSupervisor:
    ...
    async def generate_management_report(self, 
                                       ...
                                       masked_images: Dict[str, str] = None) -> Dict[str, Any]:
        """맞춤형 관리 피드백 리포트 생성 (백엔드 연동 버전)"""
        ...
        initial_state = ManagementReportState(
            ...
            masked_images=masked_images or {},
            pet_info={},
            brush_style_info={},
            custom_contexts={},
            brushing_analysis={},
...
async def main():
    ...
    masked_images = {
        'teeth_area': 'teeth3.jpg_teeth_full_area.jpg',
        'caries': 'teeth3.jpg_caries_detected.jpg',
        'calculus': 'teeth3.jpg_calculus_detected.jpg'
    }
